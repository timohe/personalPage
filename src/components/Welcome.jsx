...
class Welcome extends Component {
	...
	componentDidMount = () => {
		fetch(
			`https://api.openweathermap.org/data/2.5/weather?id=2657896&APPID=f96babb6d2d20b997bc81d553874add2`,
		)
			...
			<div className="Welcome">
				<div className="Intro-Text">
					<h1 className="welcome-intro">
						...
						<font color="#00f2e7">tech-enthusiast</font> <br /> living in{" "}
						{this.state.currentWeather}{" "}
						<i className={this.state.weatherIcon} aria-hidden="true" /> Zurich
						<br />
						<br />
						<a
						...
						>
							<i className="fab fa-linkedin i-hov" />
						</a>
						<a
							...
							rel="noopener noreferrer"
						>
							<i className="fab fa-github i-hov" />
						</a>
						<a
							href="mailto:t.hegnauer@gmail.com?Subject=Hello%20there!"
							target="_top"
						>
							<i className="fa fa-envelope i-hov" />
						</a>
						<br />
						<a
